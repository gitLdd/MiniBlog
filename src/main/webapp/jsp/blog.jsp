			...
			<c:choose>
				<c:when test="${type == 0}">
					<c:if test="${empty blogger}">
						<h1 class="m_11">最新的20篇博客</h1>
					</c:if>
					<c:if test="${!empty blogger}">
						<h1 class="m_11">${blogger.nick }的博客</h1>
					</c:if>
				</c:when>
				<c:when test="${type == 1}">
					<c:if test="${empty blogger}">
						<h1 class="m_11">全站_${selectMonth }的博客</h1>
					</c:if>
					<c:if test="${!empty blogger}">
						<h1 class="m_11">${blogger.nick }_${selectMonth }的博客</h1>
					</c:if>
				</c:when>
			</c:choose>
		</div>
							...
							<c:forEach items="${newestBlogs }" var="blog">
								...
								<div class="blog_box">
									<div class="blog_grid">
										...
										<h3>
											<a href="${pageContext.request.contextPath }/aboutBlogSingle/requestBlogSingle.do?tid=${blog.tid }&bloggerId=${blog.uid }">《${blog.title }》</a>
										</h3>
										<div class="singe_desc"
											style="height: 180px; margin: 0px auto; padding-top: 0px; padding-bottom: 0px;">
											<div class="yulan">${blog.text }</div>
											<div class="comments" style="height: 100px;">
												<ul class="links">
													<li><a href="" onclick="return false;"><i class="blog_icon1"> </i><br>
														<span>${blog.releasedate }</span></a></li>
													<li><a href="${pageContext.request.contextPath }/aboutBlog/requestBlog.do?uid=${blog.uid }&pageno=1"><i class="blog_icon2"> </i><br>
														<span>${blog.unick }</span></a></li>
													<li><a href="" onclick="return false;"><i class="blog_icon3"> </i><br>
														<span>${blog.zannum }</span></a></li>
													<li><a href="" onclick="return false;"><i class="blog_icon4"> </i><br>
														<span>${blog.talknum }</span></a></li>
												</ul>
												<div class="btn_blog">
													<a href="${pageContext.request.contextPath }/aboutBlogSingle/requestBlogSingle.do?tid=${blog.tid }&bloggerId=${blog.uid }">Read More</a>
												</div>
												<div class="clear"></div>
											</div>
										</div>
						...
						<c:otherwise>
							<c:forEach items="${page.datas }" var="Upage">
								...
								<div class="blog_box">
									<div class="blog_grid">
										<i class="documentBlog"> </i>
										<h3><a href="${pageContext.request.contextPath }/aboutBlogSingle/requestBlogSingle.do?tid=${Upage.tid }&bloggerId=${Upage.uid }">《${Upage.title }》</a>
										</h3>
										<div class="singe_desc"
											style="height: 180px; margin: 0px auto; padding-top: 0px; padding-bottom: 0px;">
											...
											<div class="comments" style="height: 100px;">
												<ul class="links">
													<li><a href="" onclick="return false;"><i class="blog_icon1"> </i><br>
														<span>${Upage.releasedate }</span></a></li>
													<li><a href="${pageContext.request.contextPath }/aboutBlog/requestBlog.do?uid=${blogger.uid }&pageno=1"><i class="blog_icon2"> </i><br>
														<span>${blogger.nick }</span></a></li>
													<li><a href="" onclick="return false;"><i class="blog_icon3"> </i><br>
														<span>${Upage.zannum }</span></a></li>
													<li><a href="" onclick="return false;"><i class="blog_icon4"> </i><br>
														<span>${Upage.talknum }</span></a></li>
												</ul>
												<div class="btn_blog">
								...
								<!-- 选择页数超链接 -->
								<!-- 超链接需要根据type的值判断是否需要在后面添加参数，如日期、标签什么的  -->
								<center>
								<ul class="dc_pagination dc_paginationA dc_paginationA06">
									<c:choose>
										<%-- 没有数据 --%>
										<c:when test="${page.totalPages == 0 }">
											<li id="isNull"><a href="" onclick="return false;">该用户没有发表任何文章</a></li>
										</c:when>
										<%-- 只有一页 --%>
										...
										<c:when test="${page.pageno == 1 }">
											...
											<c:forEach var="i" begin="1" end="${page.totalPages }">
												<c:choose>
													...
													<c:otherwise>
														<c:choose>
															<c:when test="${type == 0}">
																<li><a href="${pageContext.request.contextPath}/aboutBlog/requestBlog.do?uid=${blogger.uid }&pageno=${i }">${i }</a></li>
															</c:when>
															<c:when test="${type == 1}">
																<li><a href="${pageContext.request.contextPath}/aboutBlog/requestBlog.do?uid=${blogger.uid }&pageno=${i }&yearMonth=${selectMonth}">${i }</a></li>
															</c:when>
															<c:otherwise>
															</c:otherwise>
														</c:choose>
											...
											<c:choose>
												<c:when test="${type == 0}">
													<li><a href="${pageContext.request.contextPath}/aboutBlog/requestBlog.do?uid=${blogger.uid }&pageno=${page.pageno + 1 }" class="current">下一页</a></li>
												</c:when>
												<c:when test="${type == 1}">
													<li><a href="${pageContext.request.contextPath}/aboutBlog/requestBlog.do?uid=${blogger.uid }&pageno=${page.pageno + 1 }&yearMonth=${selectMonth}" class="current">下一页</a></li>
												</c:when>
												<c:otherwise>
												</c:otherwise>
											</c:choose>
										...
										<c:when test="${page.pageno == page.totalPages }">
											<c:choose>
												<c:when test="${type == 0}">
													<li><a href="${pageContext.request.contextPath}/aboutBlog/requestBlog.do?uid=${blogger.uid }&pageno=${page.pageno - 1 }" class="current">上一页</a></li>
												</c:when>
												<c:when test="${type == 1}">
													<li><a href="${pageContext.request.contextPath}/aboutBlog/requestBlog.do?uid=${blogger.uid }&pageno=${page.pageno - 1 }&yearMonth=${selectMonth}" class="current">上一页</a></li>
												</c:when>
												<c:otherwise>
												</c:otherwise>
											</c:choose>
										...
										<div class="singe_desc"
											...
											<div class="comments" style="height: 100px;">
												<ul class="links">
													<li><a href="" onclick="return false;"><i class="blog_icon1"> </i><br>
														<span>${Upage.releasedate }</span></a></li>
													<li><a href="${pageContext.request.contextPath }/aboutBlog/requestBlog.do?uid=${Upage.uid }&pageno=1"><i class="blog_icon2"> </i><br>
														<span>${Upage.unick }</span></a></li>
													<li><a href="" onclick="return false;"><i class="blog_icon3"> </i><br>
														<span>${Upage.zannum }</span></a></li>
													<li><a href="" onclick="return false;"><i class="blog_icon4"> </i><br>
														<span>${Upage.talknum }</span></a></li>
									...
									<c:choose>
										...
										<c:when test="${page.pageno == 1 }">
												...
												<c:choose>
													...
													<c:otherwise>
														<c:choose>
															<c:when test="${type == 0}">
																<c:if test="${empty blogger }">
																	<li><a href="${pageContext.request.contextPath}/aboutBlog/requestBlog.do?uid=0&pageno=${i }">${i }</a></li>
																</c:if>
																<c:if test="${!empty blogger }">
																	<li><a href="${pageContext.request.contextPath}/aboutBlog/requestBlog.do?uid=${blogger.uid }&pageno=${i }">${i }</a></li>
																</c:if>
															...
															<c:when test="${type == 1}">
																<c:if test="${empty blogger }">
																	<li><a href="${pageContext.request.contextPath}/aboutBlog/requestBlog.do?uid=0&pageno=${i }&yearMonth=${selectMonth}">${i }</a></li>
																</c:if>
																<c:if test="${!empty blogger }">
																	<li><a href="${pageContext.request.contextPath}/aboutBlog/requestBlog.do?uid=${blogger.uid }&pageno=${i }&yearMonth=${selectMonth}">${i }</a></li>
																</c:if>
											...
											<c:choose>
												<c:when test="${type == 0}">
													<c:if test="${empty blogger }">
														<li><a href="${pageContext.request.contextPath}/aboutBlog/requestBlog.do?uid=0&pageno=${page.pageno + 1 }" class="current">下一页</a></li>
													</c:if>
													<c:if test="${!empty blogger }">
														<li><a href="${pageContext.request.contextPath}/aboutBlog/requestBlog.do?uid=${blogger.uid }&pageno=${page.pageno + 1 }" class="current">下一页</a></li>
													</c:if>
										...
										<c:when test="${page.pageno == page.totalPages }">
											<c:choose>
												<c:when test="${type == 0}">
													<c:if test="${empty blogger }">
														<li><a href="${pageContext.request.contextPath}/aboutBlog/requestBlog.do?uid=0&pageno=${page.pageno - 1 }" class="current">上一页</a></li>
													</c:if>
													<c:if test="${!empty blogger }">
														<li><a href="${pageContext.request.contextPath}/aboutBlog/requestBlog.do?uid=${blogger.uid }&pageno=${page.pageno - 1 }" class="current">上一页</a></li>
													</c:if>
												...
												<c:when test="${type == 1}">
													<c:if test="${empty blogger }">
														<li><a href="${pageContext.request.contextPath}/aboutBlog/requestBlog.do?uid=0&pageno=${page.pageno - 1 }&yearMonth=${selectMonth}" class="current">上一页</a></li>
													</c:if>
													<c:if test="${!empty blogger }">
														<li><a href="${pageContext.request.contextPath}/aboutBlog/requestBlog.do?uid=${blogger.uid }&pageno=${page.pageno - 1 }&yearMonth=${selectMonth}" class="current">上一页</a></li>
													</c:if>
										...
										<c:otherwise>
											...
											<c:choose>
												...
												<c:when test="${type == 1}">
													<c:if test="${empty blogger }">
														<li><a href="${pageContext.request.contextPath}/aboutBlog/requestBlog.do?uid=0&pageno=${page.pageno + 1 }&yearMonth=${selectMonth}" class="current">下一页</a></li>
													</c:if>
													<c:if test="${!empty blogger }">
														<li><a href="${pageContext.request.contextPath}/aboutBlog/requestBlog.do?uid=${blogger.uid }&pageno=${page.pageno + 1 }&yearMonth=${selectMonth}" class="current">下一页</a></li>
													</c:if>
